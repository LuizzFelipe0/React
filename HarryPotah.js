...
const novoArray = hp.map((h, index) => {
 return `Name: ${h.name} || Patronus: ${h.patronus} `;
})
...
// Array Filtrando objeto da Casa Sonserina com Olhos Vermelhos

const house1 = hp.filter((h) => h.house.includes("Slytherin") && h.eyeColour.includes("red"));
console.log(house1);

// Array procurando obj com nome Ron Weasley

const weasley = hp.find ((h) => h.name == "Ron Weasley");
console.log(weasley);
